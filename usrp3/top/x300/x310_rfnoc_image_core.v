...
// File generated on: 2019-09-06T11:24:39.796612
// Source: /home/sugandha/src/fpgadev-rfnoc/usrp3/top/x300/x310_rfnoc_image_core.yml
// Source SHA256: dca66f14607f2c99acc0f8dfd901c0b148a7206c09632cb9e10fe4b6e964a965
...
//// IO ports //////////////////////////////////
//  axi_ram_fifo
  input  wire [  1-1:0] mem_clk,
  input  wire [  1-1:0] mem_rst,
  output wire [  2-1:0] m_axi_awid,
  output wire [ 60-1:0] m_axi_awaddr,
  ...
  output wire [ 60-1:0] m_axi_araddr,
...
//  time_keeper
  ...
  wire [31:0]       m_dram0_ctrl_tdata ,   s_dram0_ctrl_tdata ;
  wire              m_dram0_ctrl_tlast ,   s_dram0_ctrl_tlast ;
  wire              m_dram0_ctrl_tvalid,   s_dram0_ctrl_tvalid;
  wire              m_dram0_ctrl_tready,   s_dram0_ctrl_tready;
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_dram0_ctrl_tdata , m_radio1_ctrl_tdata , m_ddc1_ctrl_tdata , m_duc1_ctrl_tdata , m_radio0_ctrl_tdata , m_ddc0_ctrl_tdata , m_duc0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_dram0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_ddc1_ctrl_tvalid, m_duc1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ddc0_ctrl_tvalid, m_duc0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_dram0_ctrl_tlast , m_radio1_ctrl_tlast , m_ddc1_ctrl_tlast , m_duc1_ctrl_tlast , m_radio0_ctrl_tlast , m_ddc0_ctrl_tlast , m_duc0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_dram0_ctrl_tready, m_radio1_ctrl_tready, m_ddc1_ctrl_tready, m_duc1_ctrl_tready, m_radio0_ctrl_tready, m_ddc0_ctrl_tready, m_duc0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_dram0_ctrl_tdata , s_radio1_ctrl_tdata , s_ddc1_ctrl_tdata , s_duc1_ctrl_tdata , s_radio0_ctrl_tdata , s_ddc0_ctrl_tdata , s_duc0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_dram0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_ddc1_ctrl_tvalid, s_duc1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ddc0_ctrl_tvalid, s_duc0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_dram0_ctrl_tlast , s_radio1_ctrl_tlast , s_ddc1_ctrl_tlast , s_duc1_ctrl_tlast , s_radio0_ctrl_tlast , s_ddc0_ctrl_tlast , s_duc0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_dram0_ctrl_tready, s_radio1_ctrl_tready, s_ddc1_ctrl_tready, s_duc1_ctrl_tready, s_radio0_ctrl_tready, s_ddc0_ctrl_tready, s_duc0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  // dram0
  // ----------------------------------------------------
  wire [CHDR_W-1:0] s_dram0_port1_tdata , s_dram0_port0_tdata ;
  wire              s_dram0_port1_tlast , s_dram0_port0_tlast ;
  wire              s_dram0_port1_tvalid, s_dram0_port0_tvalid;
  wire              s_dram0_port1_tready, s_dram0_port0_tready;
  wire [CHDR_W-1:0] m_dram0_port1_tdata , m_dram0_port0_tdata ;
  wire              m_dram0_port1_tlast , m_dram0_port0_tlast ;
  wire              m_dram0_port1_tvalid, m_dram0_port0_tvalid;
  wire              m_dram0_port1_tready, m_dram0_port0_tready;

  //  axi_ram_fifo
  wire [  1-1:0] dram0_mem_clk;
  wire [  1-1:0] dram0_mem_rst;
  wire [  2-1:0] dram0_m_axi_awid;
  wire [ 60-1:0] dram0_m_axi_awaddr;
  wire [ 16-1:0] dram0_m_axi_awlen;
  wire [  6-1:0] dram0_m_axi_awsize;
  wire [  4-1:0] dram0_m_axi_awburst;
  wire [  2-1:0] dram0_m_axi_awlock;
  wire [  8-1:0] dram0_m_axi_awcache;
  wire [  6-1:0] dram0_m_axi_awprot;
  wire [  8-1:0] dram0_m_axi_awqos;
  wire [  8-1:0] dram0_m_axi_awregion;
  wire [  2-1:0] dram0_m_axi_awuser;
  wire [  2-1:0] dram0_m_axi_awvalid;
  wire [  2-1:0] dram0_m_axi_awready;
  wire [128-1:0] dram0_m_axi_wdata;
  wire [ 16-1:0] dram0_m_axi_wstrb;
  wire [  2-1:0] dram0_m_axi_wlast;
  wire [  2-1:0] dram0_m_axi_wuser;
  wire [  2-1:0] dram0_m_axi_wvalid;
  wire [  2-1:0] dram0_m_axi_wready;
  wire [  2-1:0] dram0_m_axi_bid;
  wire [  4-1:0] dram0_m_axi_bresp;
  wire [  2-1:0] dram0_m_axi_buser;
  wire [  2-1:0] dram0_m_axi_bvalid;
  wire [  2-1:0] dram0_m_axi_bready;
  wire [  2-1:0] dram0_m_axi_arid;
  wire [ 60-1:0] dram0_m_axi_araddr;
  wire [ 16-1:0] dram0_m_axi_arlen;
  wire [  6-1:0] dram0_m_axi_arsize;
  wire [  4-1:0] dram0_m_axi_arburst;
  wire [  2-1:0] dram0_m_axi_arlock;
  wire [  8-1:0] dram0_m_axi_arcache;
  wire [  6-1:0] dram0_m_axi_arprot;
  wire [  8-1:0] dram0_m_axi_arqos;
  wire [  8-1:0] dram0_m_axi_arregion;
  wire [  2-1:0] dram0_m_axi_aruser;
  wire [  2-1:0] dram0_m_axi_arvalid;
  wire [  2-1:0] dram0_m_axi_arready;
  wire [  2-1:0] dram0_m_axi_rid;
  wire [128-1:0] dram0_m_axi_rdata;
  wire [  4-1:0] dram0_m_axi_rresp;
  wire [  2-1:0] dram0_m_axi_rlast;
  wire [  2-1:0] dram0_m_axi_ruser;
  wire [  2-1:0] dram0_m_axi_rvalid;
  wire [  2-1:0] dram0_m_axi_rready;
  ...
  rfnoc_block_axi_ram_fifo #(
    ...
    .mem_clk(dram0_mem_clk),
    .mem_rst(dram0_mem_rst),
    .m_axi_awid(dram0_m_axi_awid),
    .m_axi_awaddr(dram0_m_axi_awaddr),
    .m_axi_awlen(dram0_m_axi_awlen),
    .m_axi_awsize(dram0_m_axi_awsize),
    .m_axi_awburst(dram0_m_axi_awburst),
    .m_axi_awlock(dram0_m_axi_awlock),
    .m_axi_awcache(dram0_m_axi_awcache),
    .m_axi_awprot(dram0_m_axi_awprot),
    .m_axi_awqos(dram0_m_axi_awqos),
    .m_axi_awregion(dram0_m_axi_awregion),
    .m_axi_awuser(dram0_m_axi_awuser),
    .m_axi_awvalid(dram0_m_axi_awvalid),
    .m_axi_awready(dram0_m_axi_awready),
    .m_axi_wdata(dram0_m_axi_wdata),
    .m_axi_wstrb(dram0_m_axi_wstrb),
    .m_axi_wlast(dram0_m_axi_wlast),
    .m_axi_wuser(dram0_m_axi_wuser),
    .m_axi_wvalid(dram0_m_axi_wvalid),
    .m_axi_wready(dram0_m_axi_wready),
    .m_axi_bid(dram0_m_axi_bid),
    .m_axi_bresp(dram0_m_axi_bresp),
    .m_axi_buser(dram0_m_axi_buser),
    .m_axi_bvalid(dram0_m_axi_bvalid),
    .m_axi_bready(dram0_m_axi_bready),
    .m_axi_arid(dram0_m_axi_arid),
    .m_axi_araddr(dram0_m_axi_araddr),
    .m_axi_arlen(dram0_m_axi_arlen),
    .m_axi_arsize(dram0_m_axi_arsize),
    .m_axi_arburst(dram0_m_axi_arburst),
    .m_axi_arlock(dram0_m_axi_arlock),
    .m_axi_arcache(dram0_m_axi_arcache),
    .m_axi_arprot(dram0_m_axi_arprot),
    .m_axi_arqos(dram0_m_axi_arqos),
    .m_axi_arregion(dram0_m_axi_arregion),
    .m_axi_aruser(dram0_m_axi_aruser),
    .m_axi_arvalid(dram0_m_axi_arvalid),
    .m_axi_arready(dram0_m_axi_arready),
    .m_axi_rid(dram0_m_axi_rid),
    .m_axi_rdata(dram0_m_axi_rdata),
    .m_axi_rresp(dram0_m_axi_rresp),
    .m_axi_rlast(dram0_m_axi_rlast),
    .m_axi_ruser(dram0_m_axi_ruser),
    .m_axi_rvalid(dram0_m_axi_rvalid),
    .m_axi_rready(dram0_m_axi_rready),

    .s_rfnoc_chdr_tdata ({s_dram0_port1_tdata , s_dram0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_dram0_port1_tlast , s_dram0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_dram0_port1_tvalid, s_dram0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_dram0_port1_tready, s_dram0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_dram0_port1_tdata , m_dram0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_dram0_port1_tlast , m_dram0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_dram0_port1_tvalid, m_dram0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_dram0_port1_tready, m_dram0_port0_tready}),
    .s_rfnoc_ctrl_tdata (s_dram0_ctrl_tdata ),
    .s_rfnoc_ctrl_tlast (s_dram0_ctrl_tlast ),
    .s_rfnoc_ctrl_tvalid(s_dram0_ctrl_tvalid),
    .s_rfnoc_ctrl_tready(s_dram0_ctrl_tready),
    .m_rfnoc_ctrl_tdata (m_dram0_ctrl_tdata ),
    .m_rfnoc_ctrl_tlast (m_dram0_ctrl_tlast ),
    .m_rfnoc_ctrl_tvalid(m_dram0_ctrl_tvalid),
    .m_rfnoc_ctrl_tready(m_dram0_ctrl_tready)
  );
  ...
  // Static Router
  // ----------------------------------------------------
  assign s_dram0_port0_tdata = m_ep0_out0_tdata ;
  assign s_dram0_port0_tlast = m_ep0_out0_tlast ;
  assign s_dram0_port0_tvalid = m_ep0_out0_tvalid;
  assign m_ep0_out0_tready = s_dram0_port0_tready;

  assign s_duc0_port0_tdata = m_dram0_port0_tdata ;
  assign s_duc0_port0_tlast = m_dram0_port0_tlast ;
  assign s_duc0_port0_tvalid = m_dram0_port0_tvalid;
  assign m_dram0_port0_tready = s_duc0_port0_tready;
  ...
  assign s_dram0_port1_tdata = m_ep2_out0_tdata ;
  assign s_dram0_port1_tlast = m_ep2_out0_tlast ;
  assign s_dram0_port1_tvalid = m_ep2_out0_tvalid;
  assign m_ep2_out0_tready = s_dram0_port1_tready;

  assign s_duc1_port0_tdata = m_dram0_port1_tdata ;
  assign s_duc1_port0_tlast = m_dram0_port1_tlast ;
  assign s_duc1_port0_tvalid = m_dram0_port1_tvalid;
  assign m_dram0_port1_tready = s_duc1_port0_tready;
  ...
  assign dram0_mem_clk = mem_clk;
  assign dram0_mem_rst = mem_rst;
  assign m_axi_awid = dram0_m_axi_awid;
  assign m_axi_awaddr = dram0_m_axi_awaddr;
  assign m_axi_awlen = dram0_m_axi_awlen;
  assign m_axi_awsize = dram0_m_axi_awsize;
  assign m_axi_awburst = dram0_m_axi_awburst;
  assign m_axi_awlock = dram0_m_axi_awlock;
  assign m_axi_awcache = dram0_m_axi_awcache;
  assign m_axi_awprot = dram0_m_axi_awprot;
  assign m_axi_awqos = dram0_m_axi_awqos;
  assign m_axi_awregion = dram0_m_axi_awregion;
  assign m_axi_awuser = dram0_m_axi_awuser;
  assign m_axi_awvalid = dram0_m_axi_awvalid;
  assign dram0_m_axi_awready = m_axi_awready;
  assign m_axi_wdata = dram0_m_axi_wdata;
  assign m_axi_wstrb = dram0_m_axi_wstrb;
  assign m_axi_wlast = dram0_m_axi_wlast;
  assign m_axi_wuser = dram0_m_axi_wuser;
  assign m_axi_wvalid = dram0_m_axi_wvalid;
  assign dram0_m_axi_wready = m_axi_wready;
  assign dram0_m_axi_bid = m_axi_bid;
  assign dram0_m_axi_bresp = m_axi_bresp;
  assign dram0_m_axi_buser = m_axi_buser;
  assign dram0_m_axi_bvalid = m_axi_bvalid;
  assign m_axi_bready = dram0_m_axi_bready;
  assign m_axi_arid = dram0_m_axi_arid;
  assign m_axi_araddr = dram0_m_axi_araddr;
  assign m_axi_arlen = dram0_m_axi_arlen;
  assign m_axi_arsize = dram0_m_axi_arsize;
  assign m_axi_arburst = dram0_m_axi_arburst;
  assign m_axi_arlock = dram0_m_axi_arlock;
  assign m_axi_arcache = dram0_m_axi_arcache;
  assign m_axi_arprot = dram0_m_axi_arprot;
  assign m_axi_arqos = dram0_m_axi_arqos;
  assign m_axi_arregion = dram0_m_axi_arregion;
  assign m_axi_aruser = dram0_m_axi_aruser;
  assign m_axi_arvalid = dram0_m_axi_arvalid;
  assign dram0_m_axi_arready = m_axi_arready;
  assign dram0_m_axi_rid = m_axi_rid;
  assign dram0_m_axi_rdata = m_axi_rdata;
  assign dram0_m_axi_rresp = m_axi_rresp;
  assign dram0_m_axi_rlast = m_axi_rlast;
  assign dram0_m_axi_ruser = m_axi_ruser;
  assign dram0_m_axi_rvalid = m_axi_rvalid;
  assign m_axi_rready = dram0_m_axi_rready;
