...
create_clock -name CAT_DATA_CLK -period 16.276 [get_ports CAT_DATA_CLK]

# TODO add constraints for catcodec clock domain crossing
...
#Pin 16
#NET DB_SCL		IOSTANDARD = LVCMOS18	|	LOC = J21;
...
#Pin 18
#NET DB_SDA		IOSTANDARD = LVCMOS18	|	LOC = J22;
...
#Pin 20
set_property PACKAGE_PIN K21 [get_ports {DB_EXP_1_8V[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DB_EXP_1_8V[2]}]
...
#Pin 22
set_property PACKAGE_PIN L22 [get_ports {DB_EXP_1_8V[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DB_EXP_1_8V[3]}]
...
#Pin 24
set_property PACKAGE_PIN L21 [get_ports {DB_EXP_1_8V[4]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DB_EXP_1_8V[4]}]
...
#Pin 30
set_property PACKAGE_PIN M20 [get_ports {DB_EXP_1_8V[7]}]
set_property IOSTANDARD LVCMOS18 [get_ports {DB_EXP_1_8V[7]}]
