...
// File generated on: 2019-09-12T10:40:28.101900
// Source: /home/wfife/Projects/eRFNoC/fpgadev/usrp3/top/n3xx/n310_rfnoc_image_core.yml
// Source SHA256: de5c15e1b4a69a47afc75faf896b1c1f452077c6cc1d73183804388c4cfb452e
...
//  time_keeper
  ...
  // ----------------------------------------------------
  wire              duc1_duc_clk;
  wire [CHDR_W-1:0] s_duc1_port1_tdata , s_duc1_port0_tdata ;
  wire              s_duc1_port1_tlast , s_duc1_port0_tlast ;
  wire              s_duc1_port1_tvalid, s_duc1_port0_tvalid;
  wire              s_duc1_port1_tready, s_duc1_port0_tready;
  wire [CHDR_W-1:0] m_duc1_port1_tdata , m_duc1_port0_tdata ;
  wire              m_duc1_port1_tlast , m_duc1_port0_tlast ;
  wire              m_duc1_port1_tvalid, m_duc1_port0_tvalid;
  wire              m_duc1_port1_tready, m_duc1_port0_tready;
  ...
  rfnoc_block_duc #(
    ...
    .s_rfnoc_chdr_tdata ({s_duc1_port1_tdata , s_duc1_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_duc1_port1_tlast , s_duc1_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_duc1_port1_tvalid, s_duc1_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_duc1_port1_tready, s_duc1_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_duc1_port1_tdata , m_duc1_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_duc1_port1_tlast , m_duc1_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_duc1_port1_tvalid, m_duc1_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_duc1_port1_tready, m_duc1_port0_tready}),
  ...
  assign s_duc1_port1_tdata = m_ep3_out0_tdata ;
  assign s_duc1_port1_tlast = m_ep3_out0_tlast ;
  assign s_duc1_port1_tvalid = m_ep3_out0_tvalid;
  assign m_ep3_out0_tready = s_duc1_port1_tready;

  assign s_radio1_port1_tdata = m_duc1_port1_tdata ;
  assign s_radio1_port1_tlast = m_duc1_port1_tlast ;
  assign s_radio1_port1_tvalid = m_duc1_port1_tvalid;
  assign m_duc1_port1_tready = s_radio1_port1_tready;
  ...
  assign ddc1_ddc_clk = rfnoc_chdr_clk;
  assign duc1_duc_clk = rfnoc_chdr_clk;
