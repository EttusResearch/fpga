...
#set_clock_groups -asynchronous -group [get_clocks bus_clk_div2] -group [get_clocks MGT156MHZ_CLK1]
#set_clock_groups -asynchronous -group [get_clocks -filter {NAME =~ *sfpp_io_*/ten_gige_phy_i/ten_gig_eth_pcs_pma_i/*/gtxe2_i/RXOUTCLK}] -group [get_clocks MGT156MHZ_CLK1]
#set_clock_groups -asynchronous -group [get_clocks -filter {NAME =~ *sfpp_io_*/ten_gige_phy_i/ten_gig_eth_pcs_pma_i/*/gtxe2_i/TXOUTCLK}] -group [get_clocks MGT156MHZ_CLK1]
#
