...
// File generated on: 2019-09-13T16:27:41.566273
// Source: /home/wfife/Projects/eRFNoC/fpgadev/usrp3/top/n3xx/n320_rfnoc_image_core.yml
// Source SHA256: b35c58411b9b9f62f17857f4258d4aed8202f5e2b52e411615969532103d6581
...
//  time_keeper
  ...
  // ----------------------------------------------------
  wire              ddc0_ddc_clk;
  wire [CHDR_W-1:0] s_ddc0_port0_tdata ;
  wire              s_ddc0_port0_tlast ;
  wire              s_ddc0_port0_tvalid;
  wire              s_ddc0_port0_tready;
  wire [CHDR_W-1:0] m_ddc0_port0_tdata ;
  wire              m_ddc0_port0_tlast ;
  wire              m_ddc0_port0_tvalid;
  wire              m_ddc0_port0_tready;
  ...
  rfnoc_block_ddc #(
    ...
    .s_rfnoc_chdr_tdata ({s_ddc0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_ddc0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_ddc0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_ddc0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_ddc0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_ddc0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_ddc0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_ddc0_port0_tready}),
  ...
  wire [CHDR_W-1:0] s_radio0_port0_tdata ;
  wire              s_radio0_port0_tlast ;
  wire              s_radio0_port0_tvalid;
  wire              s_radio0_port0_tready;
  wire [CHDR_W-1:0] m_radio0_port0_tdata ;
  wire              m_radio0_port0_tlast ;
  wire              m_radio0_port0_tvalid;
  wire              m_radio0_port0_tready;
  ...
  rfnoc_block_radio #(
    ...
    .s_rfnoc_chdr_tdata ({s_radio0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_radio0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_radio0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_radio0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_radio0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_radio0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_radio0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_radio0_port0_tready}),
  ...
  // ----------------------------------------------------
  wire              ddc1_ddc_clk;
  wire [CHDR_W-1:0] s_ddc1_port0_tdata ;
  wire              s_ddc1_port0_tlast ;
  wire              s_ddc1_port0_tvalid;
  wire              s_ddc1_port0_tready;
  wire [CHDR_W-1:0] m_ddc1_port0_tdata ;
  wire              m_ddc1_port0_tlast ;
  wire              m_ddc1_port0_tvalid;
  wire              m_ddc1_port0_tready;
  ...
  rfnoc_block_ddc #(
    ...
    .s_rfnoc_chdr_tdata ({s_ddc1_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_ddc1_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_ddc1_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_ddc1_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_ddc1_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_ddc1_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_ddc1_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_ddc1_port0_tready}),
  ...
  wire [CHDR_W-1:0] s_radio1_port0_tdata ;
  wire              s_radio1_port0_tlast ;
  wire              s_radio1_port0_tvalid;
  wire              s_radio1_port0_tready;
  wire [CHDR_W-1:0] m_radio1_port0_tdata ;
  wire              m_radio1_port0_tlast ;
  wire              m_radio1_port0_tvalid;
  wire              m_radio1_port0_tready;
  ...
  rfnoc_block_radio #(
    ...
    .s_rfnoc_chdr_tdata ({s_radio1_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_radio1_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_radio1_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_radio1_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_radio1_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_radio1_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_radio1_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_radio1_port0_tready}),
  ...
  assign s_duc1_port0_tdata = m_ep1_out0_tdata ;
  assign s_duc1_port0_tlast = m_ep1_out0_tlast ;
  assign s_duc1_port0_tvalid = m_ep1_out0_tvalid;
  assign m_ep1_out0_tready = s_duc1_port0_tready;
  ...
  assign s_ep1_in0_tdata = m_ddc1_port0_tdata ;
  assign s_ep1_in0_tlast = m_ddc1_port0_tlast ;
  assign s_ep1_in0_tvalid = m_ddc1_port0_tvalid;
  assign m_ddc1_port0_tready = s_ep1_in0_tready;
  ...
  assign ddc0_ddc_clk = radio_clk;
  assign duc0_duc_clk = radio_clk;
  assign radio1_radio_clk = radio_clk;
  assign ddc1_ddc_clk = radio_clk;
  assign duc1_duc_clk = radio_clk;
