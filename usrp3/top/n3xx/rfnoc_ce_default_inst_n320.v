  localparam NUM_CE = 6;  // Must be no more than 10 (6 ports taken by transport and IO connected CEs)
  ...
  noc_block_ddc #( .STR_SINK_FIFOSIZE(12), .NUM_CHAINS(1), .NOC_ID(64'hDDC0_0000_0000_0001)) inst_noc_block_ddc_0 (
  ...
  noc_block_ddc #( .STR_SINK_FIFOSIZE(12), .NUM_CHAINS(1), .NOC_ID(64'hDDC0_0000_0000_0001)) inst_noc_block_ddc_1 (
    .bus_clk(bus_clk), .bus_rst(bus_rst),
    .ce_clk(ce_clk), .ce_rst(ce_rst),
