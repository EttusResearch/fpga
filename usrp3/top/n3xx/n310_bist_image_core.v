...
// File generated on: 2019-10-29T09:51:09.088225
// Source: ./n310_bist_image_core.yml
// Source SHA256: e34e6892aff2ad23a5b1d86c6ce35f1c0656a2175df70541c68f5c3224740bab
...
//  dram
  ...
  // fifo0
  // ----------------------------------------------------
  wire [CHDR_W-1:0] s_fifo0_port3_tdata , s_fifo0_port2_tdata , s_fifo0_port1_tdata , s_fifo0_port0_tdata ;
  wire              s_fifo0_port3_tlast , s_fifo0_port2_tlast , s_fifo0_port1_tlast , s_fifo0_port0_tlast ;
  wire              s_fifo0_port3_tvalid, s_fifo0_port2_tvalid, s_fifo0_port1_tvalid, s_fifo0_port0_tvalid;
  wire              s_fifo0_port3_tready, s_fifo0_port2_tready, s_fifo0_port1_tready, s_fifo0_port0_tready;
  wire [CHDR_W-1:0] m_fifo0_port3_tdata , m_fifo0_port2_tdata , m_fifo0_port1_tdata , m_fifo0_port0_tdata ;
  wire              m_fifo0_port3_tlast , m_fifo0_port2_tlast , m_fifo0_port1_tlast , m_fifo0_port0_tlast ;
  wire              m_fifo0_port3_tvalid, m_fifo0_port2_tvalid, m_fifo0_port1_tvalid, m_fifo0_port0_tvalid;
  wire              m_fifo0_port3_tready, m_fifo0_port2_tready, m_fifo0_port1_tready, m_fifo0_port0_tready;

  //  axi_ram
  wire [  1-1:0] fifo0_mem_clk;
  wire [  1-1:0] fifo0_mem_rst;
  ...
  rfnoc_block_axi_ram_fifo #(
    ...
    .s_rfnoc_chdr_tdata ({s_fifo0_port3_tdata , s_fifo0_port2_tdata , s_fifo0_port1_tdata , s_fifo0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_fifo0_port3_tlast , s_fifo0_port2_tlast , s_fifo0_port1_tlast , s_fifo0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_fifo0_port3_tvalid, s_fifo0_port2_tvalid, s_fifo0_port1_tvalid, s_fifo0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_fifo0_port3_tready, s_fifo0_port2_tready, s_fifo0_port1_tready, s_fifo0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_fifo0_port3_tdata , m_fifo0_port2_tdata , m_fifo0_port1_tdata , m_fifo0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_fifo0_port3_tlast , m_fifo0_port2_tlast , m_fifo0_port1_tlast , m_fifo0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_fifo0_port3_tvalid, m_fifo0_port2_tvalid, m_fifo0_port1_tvalid, m_fifo0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_fifo0_port3_tready, m_fifo0_port2_tready, m_fifo0_port1_tready, m_fifo0_port0_tready}),
  ...
  // Static Router
  // ----------------------------------------------------
  assign s_radio0_port0_tdata = m_ep0_out0_tdata ;
  assign s_radio0_port0_tlast = m_ep0_out0_tlast ;
  assign s_radio0_port0_tvalid = m_ep0_out0_tvalid;
  assign m_ep0_out0_tready = s_radio0_port0_tready;

  assign s_ep0_in0_tdata = m_radio0_port0_tdata ;
  assign s_ep0_in0_tlast = m_radio0_port0_tlast ;
  assign s_ep0_in0_tvalid = m_radio0_port0_tvalid;
  assign m_radio0_port0_tready = s_ep0_in0_tready;

  assign s_radio0_port1_tdata = m_ep1_out0_tdata ;
  assign s_radio0_port1_tlast = m_ep1_out0_tlast ;
  assign s_radio0_port1_tvalid = m_ep1_out0_tvalid;
  assign m_ep1_out0_tready = s_radio0_port1_tready;

  assign s_ep1_in0_tdata = m_radio0_port1_tdata ;
  assign s_ep1_in0_tlast = m_radio0_port1_tlast ;
  assign s_ep1_in0_tvalid = m_radio0_port1_tvalid;
  assign m_radio0_port1_tready = s_ep1_in0_tready;

  assign s_radio1_port0_tdata = m_ep2_out0_tdata ;
  assign s_radio1_port0_tlast = m_ep2_out0_tlast ;
  assign s_radio1_port0_tvalid = m_ep2_out0_tvalid;
  assign m_ep2_out0_tready = s_radio1_port0_tready;

  assign s_ep2_in0_tdata = m_radio1_port0_tdata ;
  assign s_ep2_in0_tlast = m_radio1_port0_tlast ;
  assign s_ep2_in0_tvalid = m_radio1_port0_tvalid;
  assign m_radio1_port0_tready = s_ep2_in0_tready;

  assign s_radio1_port1_tdata = m_ep3_out0_tdata ;
  assign s_radio1_port1_tlast = m_ep3_out0_tlast ;
  assign s_radio1_port1_tvalid = m_ep3_out0_tvalid;
  assign m_ep3_out0_tready = s_radio1_port1_tready;

  assign s_ep3_in0_tdata = m_radio1_port1_tdata ;
  assign s_ep3_in0_tlast = m_radio1_port1_tlast ;
  assign s_ep3_in0_tvalid = m_radio1_port1_tvalid;
  assign m_radio1_port1_tready = s_ep3_in0_tready;

  assign s_fifo0_port0_tdata = m_ep4_out0_tdata ;
  assign s_fifo0_port0_tlast = m_ep4_out0_tlast ;
  assign s_fifo0_port0_tvalid = m_ep4_out0_tvalid;
  assign m_ep4_out0_tready = s_fifo0_port0_tready;

  assign s_ep4_in0_tdata = m_fifo0_port0_tdata ;
  assign s_ep4_in0_tlast = m_fifo0_port0_tlast ;
  assign s_ep4_in0_tvalid = m_fifo0_port0_tvalid;
  assign m_fifo0_port0_tready = s_ep4_in0_tready;

  assign s_fifo0_port1_tdata = m_ep5_out0_tdata ;
  assign s_fifo0_port1_tlast = m_ep5_out0_tlast ;
  assign s_fifo0_port1_tvalid = m_ep5_out0_tvalid;
  assign m_ep5_out0_tready = s_fifo0_port1_tready;

  assign s_ep5_in0_tdata = m_fifo0_port1_tdata ;
  assign s_ep5_in0_tlast = m_fifo0_port1_tlast ;
  assign s_ep5_in0_tvalid = m_fifo0_port1_tvalid;
  assign m_fifo0_port1_tready = s_ep5_in0_tready;


  // ----------------------------------------------------
  // Unused Ports
  // ----------------------------------------------------
  assign s_fifo0_port2_tdata  = {CHDR_W{1'b0}};
  assign s_fifo0_port2_tlast  = 1'b0;
  assign s_fifo0_port2_tvalid = 1'b0;
  assign s_fifo0_port3_tdata  = {CHDR_W{1'b0}};
  assign s_fifo0_port3_tlast  = 1'b0;
  assign s_fifo0_port3_tvalid = 1'b0;
  assign m_fifo0_port2_tready = 1'b1;
  assign m_fifo0_port3_tready = 1'b1;
  ...
  assign fifo0_mem_clk = mem_clk;
  assign fifo0_mem_rst = mem_rst;
