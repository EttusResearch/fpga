...
# FIXME in RevB (not a clock pin)
#set_property PACKAGE_PIN AH18 [get_ports DBA_CPRI_REFCLK_P]
#set_property PACKAGE_PIN AJ18 [get_ports DBA_CPRI_REFCLK_N]

set_property PACKAGE_PIN N8 [get_ports DBA_MGTCLK_P]
set_property PACKAGE_PIN N7 [get_ports DBA_MGTCLK_N]

set_property PACKAGE_PIN AF14 [get_ports DBA_FPGA_SYSREF_P]
set_property PACKAGE_PIN AG14 [get_ports DBA_FPGA_SYSREF_N]

set_property PACKAGE_PIN C2 [get_ports DBA_CPLD_PL_SPI_SCLK] ; # Swapped vs schematic for gclk (swapped with mosi)
...
set_property PACKAGE_PIN AD14 [get_ports DBA_DAC_SYNCB_P] ;# These were swapped, RTL is negated.
set_property PACKAGE_PIN AD13 [get_ports DBA_DAC_SYNCB_N] ;# These were swapped, RTL is negated.

# These need to be fixed!!!
# set_property PACKAGE_PIN P6 [get_ports DBA_RX_P[3]]
# set_property PACKAGE_PIN T6 [get_ports DBA_RX_P[2]]
# set_property PACKAGE_PIN V6 [get_ports DBA_RX_P[1]]
# set_property PACKAGE_PIN U4 [get_ports DBA_RX_P[0]]
# set_property PACKAGE_PIN P5 [get_ports DBA_RX_N[3]]
# set_property PACKAGE_PIN T5 [get_ports DBA_RX_N[2]]
# set_property PACKAGE_PIN V5 [get_ports DBA_RX_N[1]]
# set_property PACKAGE_PIN U3 [get_ports DBA_RX_N[0]]
...
#set_property PACKAGE_PIN AK16 [get_ports DBA_CPLD_UNUSED[12]]
#set_property PACKAGE_PIN AJ16 [get_ports DBA_CPLD_UNUSED[13]]
...
# FIXME in RevB (not a clock pin)
#set_property PACKAGE_PIN AG24 [get_ports DBB_CPRI_REFCLK_P]
#set_property PACKAGE_PIN AG25 [get_ports DBB_CPRI_REFCLK_N]

set_property PACKAGE_PIN W8 [get_ports DBB_MGTCLK_P]
set_property PACKAGE_PIN W7 [get_ports DBB_MGTCLK_N]

set_property PACKAGE_PIN AG21 [get_ports DBB_FPGA_SYSREF_P]
set_property PACKAGE_PIN AH21 [get_ports DBB_FPGA_SYSREF_N]

set_property PACKAGE_PIN K6 [get_ports DBB_CPLD_PL_SPI_SCLK] ; # Swapped vs schematic for gclk (swapped with mosi)
...
# set_property PACKAGE_PIN AC4 [get_ports DBB_RX_P[1]]
# set_property PACKAGE_PIN AB6 [get_ports DBB_RX_P[0]]
# set_property PACKAGE_PIN AA3 [get_ports DBB_RX_N[3]]
# set_property PACKAGE_PIN Y5  [get_ports DBB_RX_N[2]]
# set_property PACKAGE_PIN AC3 [get_ports DBB_RX_N[1]]
# set_property PACKAGE_PIN AB5 [get_ports DBB_RX_N[0]]

# set_property PACKAGE_PIN AB2 [get_ports DBB_TX_P[0]]
# set_property PACKAGE_PIN Y2  [get_ports DBB_TX_P[1]]
# set_property PACKAGE_PIN V2  [get_ports DBB_TX_P[2]]
# set_property PACKAGE_PIN W4  [get_ports DBB_TX_P[3]]
# set_property PACKAGE_PIN AB1 [get_ports DBB_TX_N[0]]
# set_property PACKAGE_PIN Y1  [get_ports DBB_TX_N[1]]
# set_property PACKAGE_PIN V1  [get_ports DBB_TX_N[2]]
# set_property PACKAGE_PIN W3  [get_ports DBB_TX_N[3]]
...
#set_property PACKAGE_PIN AJ23 [get_ports DBB_CPLD_UNUSED[12]]
#set_property PACKAGE_PIN AJ24 [get_ports DBB_CPLD_UNUSED[13]]
