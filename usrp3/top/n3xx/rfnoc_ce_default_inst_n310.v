  ...
  noc_block_ddc #( .NUM_CHAINS(NUM_CHANNELS_PER_RADIO)) inst_noc_block_ddc_0 (
  ...
  noc_block_ddc #( .NUM_CHAINS(NUM_CHANNELS_PER_RADIO)) inst_noc_block_ddc_1 (
    .bus_clk(bus_clk), .bus_rst(bus_rst),
    .ce_clk(ce_clk), .ce_rst(ce_rst),
  ...
  noc_block_duc #( .NUM_CHAINS(NUM_CHANNELS_PER_RADIO), .NOC_ID(64'hD0C0000000000002)) inst_noc_block_duc_0 (
    .bus_clk(bus_clk), .bus_rst(bus_rst),
    .ce_clk(ce_clk), .ce_rst(ce_rst),
  ...
  noc_block_duc #( .NUM_CHAINS(NUM_CHANNELS_PER_RADIO), .NOC_ID(64'hD0C0000000000002)) inst_noc_block_duc_1 (
    .bus_clk(bus_clk), .bus_rst(bus_rst),
    .ce_clk(ce_clk), .ce_rst(ce_rst),
