...
// File generated on: 2019-09-27T09:03:25.757474
// Source: /home/wfife/Projects/eRFNoC/fpgadev/usrp3/top/e320/e320_rfnoc_image_core.yml
// Source SHA256: 7a84b2dc5b69b9d06e08cf17a497ddca59875d9fa7708b6bb894e386ab38ccf2
...
//  time_keeper
  ...
  chdr_crossbar_nxn #(
    ...
    .device_id      (device_id),
    .s_axis_tdata   ({ep1_to_xb_tdata, ep0_to_xb_tdata, s_dma_tdata, s_eth_tdata}),
    .s_axis_tlast   ({ep1_to_xb_tlast, ep0_to_xb_tlast, s_dma_tlast, s_eth_tlast}),
    .s_axis_tvalid  ({ep1_to_xb_tvalid, ep0_to_xb_tvalid, s_dma_tvalid, s_eth_tvalid}),
    .s_axis_tready  ({ep1_to_xb_tready, ep0_to_xb_tready, s_dma_tready, s_eth_tready}),
    .m_axis_tdata   ({xb_to_ep1_tdata, xb_to_ep0_tdata, m_dma_tdata, m_eth_tdata}),
    .m_axis_tlast   ({xb_to_ep1_tlast, xb_to_ep0_tlast, m_dma_tlast, m_eth_tlast}),
    .m_axis_tvalid  ({xb_to_ep1_tvalid, xb_to_ep0_tvalid, m_dma_tvalid, m_eth_tvalid}),
    .m_axis_tready  ({xb_to_ep1_tready, xb_to_ep0_tready, m_dma_tready, m_eth_tready}),
    .ext_rtcfg_stb  (1'h0),
  ...
  // ----------------------------------------------------
  wire              duc0_duc_clk;
  wire [CHDR_W-1:0] s_duc0_port1_tdata , s_duc0_port0_tdata ;
  wire              s_duc0_port1_tlast , s_duc0_port0_tlast ;
  wire              s_duc0_port1_tvalid, s_duc0_port0_tvalid;
  wire              s_duc0_port1_tready, s_duc0_port0_tready;
  wire [CHDR_W-1:0] m_duc0_port1_tdata , m_duc0_port0_tdata ;
  wire              m_duc0_port1_tlast , m_duc0_port0_tlast ;
  wire              m_duc0_port1_tvalid, m_duc0_port0_tvalid;
  wire              m_duc0_port1_tready, m_duc0_port0_tready;
  ...
  rfnoc_block_duc #(
    ...
    .s_rfnoc_chdr_tdata ({s_duc0_port1_tdata , s_duc0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_duc0_port1_tlast , s_duc0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_duc0_port1_tvalid, s_duc0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_duc0_port1_tready, s_duc0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_duc0_port1_tdata , m_duc0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_duc0_port1_tlast , m_duc0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_duc0_port1_tvalid, m_duc0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_duc0_port1_tready, m_duc0_port0_tready}),
  ...
  // fifo0
  // ----------------------------------------------------
  wire [CHDR_W-1:0] s_fifo0_port1_tdata , s_fifo0_port0_tdata ;
  wire              s_fifo0_port1_tlast , s_fifo0_port0_tlast ;
  wire              s_fifo0_port1_tvalid, s_fifo0_port0_tvalid;
  wire              s_fifo0_port1_tready, s_fifo0_port0_tready;
  wire [CHDR_W-1:0] m_fifo0_port1_tdata , m_fifo0_port0_tdata ;
  wire              m_fifo0_port1_tlast , m_fifo0_port0_tlast ;
  wire              m_fifo0_port1_tvalid, m_fifo0_port0_tvalid;
  wire              m_fifo0_port1_tready, m_fifo0_port0_tready;
  ...
  rfnoc_block_axi_ram_fifo #(
    ...
    .s_rfnoc_chdr_tdata ({s_fifo0_port1_tdata , s_fifo0_port0_tdata }),
    .s_rfnoc_chdr_tlast ({s_fifo0_port1_tlast , s_fifo0_port0_tlast }),
    .s_rfnoc_chdr_tvalid({s_fifo0_port1_tvalid, s_fifo0_port0_tvalid}),
    .s_rfnoc_chdr_tready({s_fifo0_port1_tready, s_fifo0_port0_tready}),
    .m_rfnoc_chdr_tdata ({m_fifo0_port1_tdata , m_fifo0_port0_tdata }),
    .m_rfnoc_chdr_tlast ({m_fifo0_port1_tlast , m_fifo0_port0_tlast }),
    .m_rfnoc_chdr_tvalid({m_fifo0_port1_tvalid, m_fifo0_port0_tvalid}),
    .m_rfnoc_chdr_tready({m_fifo0_port1_tready, m_fifo0_port0_tready}),
  ...
  // Static Router
  // ----------------------------------------------------
  assign s_fifo0_port0_tdata = m_ep0_out0_tdata ;
  assign s_fifo0_port0_tlast = m_ep0_out0_tlast ;
  assign s_fifo0_port0_tvalid = m_ep0_out0_tvalid;
  assign m_ep0_out0_tready = s_fifo0_port0_tready;

  assign s_duc0_port0_tdata = m_fifo0_port0_tdata ;
  assign s_duc0_port0_tlast = m_fifo0_port0_tlast ;
  assign s_duc0_port0_tvalid = m_fifo0_port0_tvalid;
  assign m_fifo0_port0_tready = s_duc0_port0_tready;
  ...
  assign s_fifo0_port1_tdata = m_ep1_out0_tdata ;
  assign s_fifo0_port1_tlast = m_ep1_out0_tlast ;
  assign s_fifo0_port1_tvalid = m_ep1_out0_tvalid;
  assign m_ep1_out0_tready = s_fifo0_port1_tready;

  assign s_duc0_port1_tdata = m_fifo0_port1_tdata ;
  assign s_duc0_port1_tlast = m_fifo0_port1_tlast ;
  assign s_duc0_port1_tvalid = m_fifo0_port1_tvalid;
  assign m_fifo0_port1_tready = s_duc0_port1_tready;

  assign s_radio0_port1_tdata = m_duc0_port1_tdata ;
  assign s_radio0_port1_tlast = m_duc0_port1_tlast ;
  assign s_radio0_port1_tvalid = m_duc0_port1_tvalid;
  assign m_duc0_port1_tready = s_radio0_port1_tready;
  ...
  assign duc0_duc_clk = rfnoc_chdr_clk;
  assign ddc0_ddc_clk = rfnoc_chdr_clk;
