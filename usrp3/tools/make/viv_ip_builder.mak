...
BUILD_VIVADO_IP = \
	...
	export VIV_ERR=0; \
	vivado -mode batch -source $(call RESOLVE_PATH,$(TOOLS_DIR)/scripts/viv_generate_ip.tcl) -log $(1).log -nojournal 2>&1 | $(TOOLS_DIR)/scripts/viv_colorize.sh || export VIV_ERR=$$?; \
